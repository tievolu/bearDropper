#!/bin/sh
# https://github.com/tievolu/bearDropper
# (Original repo https://github.com/robzr/bearDropper)
...
wget -qO /etc/init.d/bearDropper https://raw.githubusercontent.com/tievolu/bearDropper/master/src/init.d/bearDropper 
wget -qO /etc/config/bearDropper https://raw.githubusercontent.com/tievolu/bearDropper/master/src/config/bearDropper
wget -qO /usr/sbin/bearDropper https://raw.githubusercontent.com/tievolu/bearDropper/master/bearDropper
